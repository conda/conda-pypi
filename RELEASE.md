...
[Anaconda Recipes]: https://github.com/AnacondaRecipes/conda-pypi-feedstock
...
Placeholder for `conda-pypi MAJOR.MINOR.PATCH` release.
...
[main]: https://github.com/AnacondaRecipes/conda-pypi-feedstock
[conda-forge]: https://github.com/conda-forge/conda-pypi-feedstock
[zulip]: https://conda.zulipchat.com/#narrow/channel/480811-releases
...
1. Clone and `cd` into the repository if you haven't done so already:
    ...
    ```bash
    $ git clone git@github.com:/conda-pypi.git
    $ cd conda-pypi
    ```
